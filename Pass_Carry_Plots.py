# -*- coding: utf-8 -*-
"""
Created on Mon Jul  3 18:03:21 2023
...
parser = Sbopen()
df, related, freeze, tactics = parser.event(3857289)

##############################################################################
# Boolean mask for filtering the dataset by team
possession=9
team1, team2 = df.team_name.unique()
#mask_team1 = ((df.type_name == 'Pass') or (df.type_name=="Carry")) & (df.team_name == team2)
mask_team1 = ((df.type_name == 'Shot') | (df.type_name == 'Shot')) #& (df.possession==possession)
test2=df.query("type_name=='Carry' or type_name=='Pass'")
##test2=test.query(f"possession=={possession}")
